...
if (isset($_POST['nId']) && !empty($_POST['nId'])) {
    ...
    if ($res->num_rows > 0) {
        ...
        while ($row = $res->fetch_assoc()) {
            ...
            $sql4 = "SELECT * FROM PicsTable WHERE idPic=" . $aktMez->get_idPic();
            ...
            $sql4 = "SELECT tName FROM TeamTable WHERE idTeam= " . $aktMez->get_idTeam();
            ...
            $aktYears = 'ismeretlen';
            if (strlen($aktMez->get_years()) > 2) {
                $aktYears = $aktMez->get_years();
            }
            $aktInfo = "-";
            if (($aktMez->get_info())) {
                $aktInfo = $aktMez->get_info();
            }
